...
#[derive(
    Identifiable, Eq, PartialEq, Clone, Debug, Serialize, Deserialize, Queryable, Insertable,
)]
...
impl Service {
    pub fn create_camera_group(
        ...
        conn.immediate_transaction::<_, super::Error, _>(|tconn| {
            ...
            diesel::insert_into(camera_groups::table)
                .values(&vec![new_camera_group.clone()])
                .execute(tconn)?;
    ...
    pub fn fetch_all_camera_groups(
        ...
        conn.transaction::<_, super::Error, _>(|tconn| {
            let groups =
                crate::schema::camera_groups::dsl::camera_groups.load::<CameraGroup>(tconn)?;
